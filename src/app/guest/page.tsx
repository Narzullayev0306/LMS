...
export default function GuestLandingPage() {
  ...
  return (
    <div className="w-[100vw] relative left-1/2 right-1/2 -ml-[50vw] -mr-[50vw] -mt-8 -mb-12 font-sans bg-white dark:bg-[#121212] text-gray-900 dark:text-white pb-0 transition-colors duration-300">
